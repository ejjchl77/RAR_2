...
class ClassifierOfflineTrain(object):
    ...
    def __init__(self, hidden_layer_size_, activate_, solver_, learning_rate_, learning_rate_init_, max_iter_, tol_, early_stopping_):
        self.hidden_layer_size=hidden_layer_size_
        self.activate=activate_
        self.solver=solver_
        self.learning_rate=learning_rate_
        self.learning_rate_init=learning_rate_init_
        self.max_iter=max_iter_
        self.tol=tol_
        self.early_stopping=early_stopping_
    ...
    def train(self, X, Y):
        ...
        #pca.compile(activation = 'adam', learning_rate
        self.pca.fit(X)
    ...
    def _init_all_models(self):
        ...
        self.classifiers = [
            ...
            MLPClassifier(self.hidden_layer_size, activation=self.activate, solver=self.solver, learning_rate=self.learning_rate, learning_rate_init=self.learning_rate_init, max_iter=self.max_iter, tol=self.tol, early_stopping=self.early_stopping),      
            AdaBoostClassifier(),
            GaussianNB(),
...
class ClassifierOnlineTest(object):
    ...
    def __init__(self, model_path, action_labels, window_size, human_id=0):
        ...
        self.THRESHOLD_SCORE_FOR_DISP = 0.3 # 변경 
