...
CROP_SAVE_PATH = "/home/ejjchl77/RAR_2/src/image/crop/" #EJ 0228
...
class MultiPersonClassifier(object):
    ...
    def classify(self, dict_id2skeleton):
        ...
        print("old_ids, cur_ids: ", old_ids, cur_ids)
        humans_not_in_view = list(old_ids - cur_ids)  # Find dissapreaed ID
...
def draw_result_img(img_disp, ith_img, humans, dict_id2skeleton,
                    skeleton_detector, multiperson_classifier, crop_save_path, DST_FOLDER_NAME): # ejadd 0228
    ...
    #EJ img copy for cropping person
    ...
    if len(dict_id2skeleton):
        for id, label in dict_id2label.items():
            ...
            crop_save_name = crop_save_path + lib_commons.get_time_string() + ".jpg"  # ejadd 0228
            lib_plot.draw_action_result(img_disp, id, skeleton, label, crop_save_name, img_origin)
    ...
    try:
        ...
        while images_loader.has_image():
            ...
            dict_id2skeleton = multiperson_tracker.track(
                skeletons, img_disp)  # int id -> np.array() skeleton
            ...
            #img_displayer.save(save_path, img_disp)
            save_path = DST_FOLDER+lib_commons.get_time_string()+'.jpg' #EJ 0228
            img_displayer.save(save_path, img_disp)
